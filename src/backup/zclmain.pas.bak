...
begin
  ...
  begin
    ...
    if agcfg.readstring('zquest', 'auto_save_interval', '') = '15' then
    begin
      bcminute.Text := '15 minutes';
    end;
    if agcfg.readstring('zquest', 'auto_save_interval', '') = '30' then
    begin
      bcminute.Text := '30 minutes';
    end;
    if agcfg.readstring('zquest', 'auto_save_interval', '') = '45' then
    begin
      bcminute.Text := '45 minutes';
    end;
    if agcfg.readstring('zquest', 'auto_save_interval', '') = '60' then
    begin
      bcminute.Text := '1 hour';
    end;
    if agcfg.readstring('zquest', 'auto_save_interval', '') = '90' then
    begin
      bcminute.Text := '90 minutes';
    end;
    if agcfg.readstring('zquest', 'auto_save_interval', '') = '120' then
    begin
...
memo3.Lines.LoadFromFile('allegro.log');
  ...
  process1.CommandLine := './zelda-l ' + ZCFullWindow + Res1 +
...
begin
  ...
  begin
    agcfg.writestring('zquest', 'auto_save_interval', '15');
  end;
  if bcminute.Text = '30 minutes' then
  begin
    agcfg.writestring('zquest', 'auto_save_interval', '30');
  end;
  if bcminute.Text = '45 minutes' then
  begin
    agcfg.writestring('zquest', 'auto_save_interval', '45');
  end;
  if bcminute.Text = '1 hour' then
  begin
    agcfg.writestring('zquest', 'auto_save_interval', '60');
  end;
  if bcminute.Text = '90 minutes' then
  begin
    agcfg.writestring('zquest', 'auto_save_interval', '90');
  end;
  if bcminute.Text = '2 hours' then
  begin
    agcfg.writestring('zquest', 'auto_save_interval', '120');
  end;
end;
...
begin
{$IFDEF LINUX}
  process2.CommandLine := './zquest-l' + zqsound;
  process2.Execute;
