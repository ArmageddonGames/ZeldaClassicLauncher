...
begin
  ...
  begin
   ...
   if zccfg.readstring('graphics', 'gfx_card', '') = 'DXSO' then
    ...
    //Begin ZQuest
    if zquestcfg.readstring('graphics', 'gfx_cardw', '') = 'DXAC' then
    begin
      ComboBox3.Text := 'DirectDraw';
    end;
   if zquestcfg.readstring('graphics', 'gfx_cardw', '') = 'DXSO' then
    begin
      ComboBox3.Text := 'DirectDraw No Accel';
    end;
    if zquestcfg.readstring('graphics', 'gfx_cardw', '') = 'DXSA'  then
    begin
      ComboBox3.Text := 'DirectDraw Safe';
    end;
    if zquestcfg.readstring('graphics', 'gfx_cardw', '') = 'DXWN' then
    begin
      ComboBox3.Text := 'DirectDraw Windowed';
    end;
    if zquestcfg.readstring('graphics', 'gfx_cardw', '') = 'DXOV'  then
    begin
      ComboBox3.Text := 'DirectDraw Overlay';
    end;
    if zquestcfg.readstring('graphics', 'gfx_cardw', '') = 'GDIB' then
    begin
      ComboBox3.Text := 'GDI (Slow)';
    end;
    //if agcfg.readstring('graphics', 'gfx_cardw', '') = '' then
    //begin
    //  agcfg.writestring('graphics', 'gfx_cardw', 'DXAC');
   ...
   if zquestcfg.readstring('graphics', 'gfx_card', '') = 'DXSO' then
    begin
      ComboBox4.Text := 'DirectDraw No Accel';
    end;
    if zquestcfg.readstring('graphics', 'gfx_card', '') = 'DXSA'  then
    begin
      ComboBox4.Text := 'DirectDraw Safe';
    end;
    if zquestcfg.readstring('graphics', 'gfx_card', '') = 'DXWN' then
    begin
      ComboBox4.Text := 'DirectDraw Windowed';
    end;
    if zquestcfg.readstring('graphics', 'gfx_card', '') = 'DXOV'  then
    begin
      ComboBox4.Text := 'DirectDraw Overlay';
    end;
    if zquestcfg.readstring('graphics', 'gfx_card', '') = 'GDIB' then
    begin
...
begin
   {$IFDEF WIN32}
  if ComboBox3.Text = 'DirectDraw' then
  begin

    zquestcfg.writestring('graphics', 'gfx_cardw', 'DXAC');
  end;

  if ComboBox3.Text = 'DirectDraw No Accel' then
  begin

    zquestcfg.writestring('graphics', 'gfx_cardw', 'DXSO');
  end;
  if ComboBox3.Text = 'DirectDraw Safe' then
  begin

    zquestcfg.writestring('graphics', 'gfx_cardw', 'DXSA');
  end;
  if ComboBox3.Text = 'DirectDraw Windowed' then
  begin

    zquestcfg.writestring('graphics', 'gfx_cardw', 'DXWN');
  end;
  if ComboBox3.Text = 'DirectDraw Overlay' then
  begin

    zquestcfg.writestring('graphics', 'gfx_cardw', 'DXOV');
  end;
  if ComboBox3.Text = 'GDI (Slow)' then
  begin
...
begin
   {$IFDEF WIN32}
  if ComboBox4.Text = 'DirectDraw' then
  begin
    zquestcfg.writestring('graphics', 'gfx_card', 'DXAC');

  end;

  if ComboBox4.Text = 'DirectDraw No Accel' then
  begin
    zquestcfg.writestring('graphics', 'gfx_card', 'DXSO');

  end;
  if ComboBox4.Text = 'DirectDraw Safe' then
  begin
    zquestcfg.writestring('graphics', 'gfx_card', 'DXSA');

  end;
  if ComboBox4.Text = 'DirectDraw Windowed' then
  begin
    zquestcfg.writestring('graphics', 'gfx_card', 'DXWN');

  end;
  if ComboBox4.Text = 'DirectDraw Overlay' then
  begin
    zquestcfg.writestring('graphics', 'gfx_card', 'DXOV');

  end;
  if ComboBox4.Text = 'GDI (Slow)' then
  begin
